...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            ltlMaps.Text = "<script src=""http://maps.google.com/maps?file=api&v=2;&key=AIzaSyBN076Ep_9B-Epybj-0InwCW6sBT5j7JI4"" type=""text/javascript""></script>"
        End If
    ...
    Private Function ConstructSitesScript(ByVal objDataTable As DataTable, ByVal objNetwork As clsNetwork) As String
        ...
        For Each objDataRow In objDataTable.Select
            ...
            markerHTML = "<div class='bubble'><b>SiteCode: </b>" & Convert.ToString(objDataRow.Item("SiteCode")) & "<br>" & _
                ...
                "<img src='images/ploticon.gif'><a href='http://data.iutahepscor.org/odmtsa/default.aspx?Database=" & strDatabaseName & "&SiteCode=" & Convert.ToString(objDataRow.Item("SiteCode")) & "' target='_blank' style='MARGIN-LEFT:10px'>View and download data</a></div>"
