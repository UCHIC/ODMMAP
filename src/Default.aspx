	...
	<form id=frmGMap runat="server">		
		...
		<asp:Panel Id="pnlQueryOptions" Visible="True" Runat="server">
			<DIV class="leftpanel" id="leftpanelcontents" style="width: 250px">
				<P style="MARGIN-LEFT: 20px"><IMG src="images/iutahlogo.gif"></P><B>Network Query</B> 
		...
		<div class="copyright"><br>
			© 2013, <A href="http://www.iutahepscor.org" target="_blank" class="copyright">iUTAH.</A><br>
			<a href="http://data.iutahepscor.org" target="_blank" class="copyright">iUTAH Modeling & Data Federation</a><br>
			All rights reserved.
		</div>
		<!-- Tabs -->
